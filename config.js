...
module.exports = {
    ...
    SESSION: process.env.ALFHA_SESSION === undefined ? '' : process.env.ALFHA_SESSION,
    ANTİLİNK: process.env.ANTİ_LİNK === undefined ? 'false' : process.env.ANTİ_LİNK,
    AUTOBIO: process.env.AUTO_BIO === undefined ? 'false' : process.env.AUTO_BIO,
    BIOTEXT: process.env.BIOTEXT === undefined ? 'ALFHAbot@whatsapp.net' : process.env.BIOTEXT,
    GANSTYLE: process.env.GAN_IMAGE === undefined ? 'https://i.hizliresim.com/loUtAb.jpg' : process.env.GAN_IMAGE,
    LANG: process.env.LANGUAGE === undefined ? 'SI' : process.env.LANGUAGE.toUpperCase(),
    ALIVEMSG: process.env.ALIVE_MESSAGE === undefined ? '```♧😂  нί i am online now```\n\n*Version:* ```v1.0```Alfha_Bot භාවිතා කිරීම ගැන ස්තූතියි.```' : process.env.ALIVE_MESSAGE,
    ALIVE_IMG_TYPE: process.env.ALIVE_IMG_TYPE === undefined ? 'pp' : process.env.ALIVE_IMG_TYPE,
    ALIVE_LOGO: process.env.ALIVE_LOGO === undefined ? 'https://telegra.ph/file/5baefb07588218bc18282.jpg' : process.env.ALIVE_LOGO,
    KICKMEMSG: process.env.KICKME_MESSAGE === undefined ? 'default' : process.env.KICKME_MESSAGE,
    BLOCKCHAT: process.env.BLOCK_CHAT === undefined ? false : process.env.BLOCK_CHAT,
    WELCOME: process.env.WELCOME === undefined ? 'pp' : process.env.WELCOME,
    OWNER: process.env.OWNER_NAME === undefined ? 'ALFHA-Sl-Team' : process.env.OWNER_NAME,
    CP_TEXT: process.env.CP_TEXT === undefined ? '꧁༺ʍǟɖɛ ɮʏ alfha ȶɦɛ ɮօȶ༻' : process.env.CP_TEXT,
    SONG_UP: process.env.SONG_UP === undefined ? '꧁•٭𝚙𝚕𝚣 𝚠𝚊𝚒𝚝𝚎 alfha 𝚋𝚘𝚝 𝚞𝚙𝚕𝚘𝚊𝚍𝚒𝚗𝚐 𝚢𝚘𝚞𝚛 𝚜𝚘𝚗𝚐 𝚚𝚞𝚒𝚌𝚔𝚕𝚢٭•꧂' : process.env.SONG_UP,
    VIDEO_DOWN: process.env.VIDEO_DOWN === undefined ? '(づ｡◕‿‿◕｡)づ Alfha Bot Downloading video ٩(˘◡˘)۶' : process.env.VIDEO_DOWN,
    VID_CP: process.env.VID_CP === undefined ? '♣💎  АГfн$ 𝔂ŤⒹ𝕃  ♜✌' : process.env.VID_CP,
    VIDEO_UP: process.env.VIDEO_UP === undefined ? '(づ｡◕‿‿◕｡)づ аlfha bot upload video٩(˘◡˘)۶' : process.env.VIDEO_UP,
    ...
    BOT: process.env.BOT_NAME === undefined ? '☮ 🇱🇰 ALFHABot-Sl™' : process.env.BOT_NAME,
    NOLOG: process.env.NO_LOG === undefined ? 'false' : process.env.NO_LOG,
    THERI_KICK: process.env.THERI_KICK === undefined ? 'false' : process.env.THERI_KICK,
    SONG_D: process.env.SONG_D === undefined ? '𝙥𝙡𝙯 𝙬𝙖𝙞𝙩 𝘼𝙇𝙁𝘼 𝙗𝙤𝙩 𝙨𝙚𝙖𝙧𝙘𝙝𝙞𝙣𝙜 𝙮𝙤𝙪𝙧 𝙨𝙤𝙣𝙜' : process.env.SONG_D,
    ...
    MENUTEXT: process.env.MENUTEXT === undefined ? '𓂀 𝔸𝕃𝔽ℍ𝔸 𝔹𝕠𝕥 𝕄𝕖𝕟𝕦 𓂀' : process.env.MENUTEXT,
    MENU_LOGO: process.env.MENU_LOGO === undefined ? 'https://telegra.ph/file/5baefb07588218bc18282.jpg' : process.env.MENU_LOGO,
    BRANCH: 'main',
    HEROKU: {
